...
export class PaisesComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.paisesService
      ...
      .subscribe(
        (res: HttpResponse<IPaises[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPaises(): void {
    this.eventSubscriber = this.eventManager.subscribe('paisesListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPaises[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
