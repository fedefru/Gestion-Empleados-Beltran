...
export class ProvinciasComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.provinciasService
      ...
      .subscribe(
        (res: HttpResponse<IProvincias[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInProvincias(): void {
    this.eventSubscriber = this.eventManager.subscribe('provinciasListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IProvincias[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
