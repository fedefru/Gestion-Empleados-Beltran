...
export class OrganigramaComponent implements OnInit, AfterViewInit {
  ...
  public cuentaAuth: any;
  public usuario!: IUsuarios;
  public empresaDelEmpleado?: number;
  ...
  ngOnInit(): void {
    ...
    this.usuarioService.findUsuarioByAlias(this.cuentaLogueada.toLowerCase()).subscribe((resp: HttpResponse<any>) => {
