...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("GestionEmpleados");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("GestionEmpleados");
        ...
        config.getMapConfigs().put("com.beltran.gestionempleados.domain.*", initializeDomainMapConfig(jHipsterProperties));
