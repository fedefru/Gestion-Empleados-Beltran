...
import { AreasDeleteDialogComponent } from 'app/entities/areas/areas-delete-dialog.component';
import { AreasService } from 'app/entities/areas/areas.service';

describe('Component Tests', () => {
  describe('Areas Management Delete Component', () => {
    let comp: AreasDeleteDialogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AreasDeleteDialogComponent, '')
        .compileComponents();
